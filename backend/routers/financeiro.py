...
def resumo(
    ...
    # Mesma fórmula do orçamento: item em m²/metro linear não é quantidade × preço.
    soma_venda = sum(schemas.calcular_total_linha(
        unidade_medida=getattr(i, 'unidade_medida', None) or 'un',
